...
*/
    $custid=$_POST['custid'];
    $cust_result = $db->prepare("SELECT * FROM customer WHERE customerID = '".$custid. "'");
    $cust_result->execute();
    $row_cust = $cust_result->fetch();
/*}
else
{
    $url=BASE_URL.'validate.php';
    header("Location: $url");
}*/
                    ...
                    <div class="col-md-12">
                        <div class="card" >
                            ...
                            <div class="content all-icons">
                                <div class="row">
                                    <form name="validcust" action="../inc/valid.php" method="POST">
                                        ...
                                        <button class="button1" id="login_button1" type="submit" name="accept"><span>Accept</span></button>
                                        <button class="button1" id="login_button1" type="submit" name="reject"><span>Reject</span></button>
                                    </form>
                                </div>
                            </div>
                        </div>
