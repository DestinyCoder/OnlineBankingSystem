            ...
            <div class="container-fluid" >
                <div class="row" >
                    <div class="col-md-12">
                        <div class="card" >
                            <div class="header">
                                <h4 class="title"><center>Search Employee</center></h4> 
                            </div>
                            <div class="content all-icons">
                                <div class="row">
                                    <form  name = "searchemp" class="search_form" action="empdetails.php" method="post">
                                        ...
                                        <select name="typetosearch">
                                            ...
                                            <option value="empemail">Search By Email</option>
                                        </select>
                                        <input type="text" name="search" class="searchtext">
                                        <button type="submit" name="submit" class="button1" style="width: 100px;height: 50px;font-size: 20px; text-align: center;">Search</button>
                                    </form> 
                                </div>
                            </div>
                        </div>
