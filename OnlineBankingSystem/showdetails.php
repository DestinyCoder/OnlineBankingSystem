...
<body>
	<div class="container" id="wrapper">
		...
		<center>
				...
				<tr>
					<td id="show_detail">Name</td>
					<td class="show_detail"><?php echo $row_cust["name"] ?></td>
				</tr>
				<tr>
					<td id="show_detail">Phone No.</td>
					<td class="show_detail"><?php echo $row_cust["phone"] ?></td>
				</tr>
				<tr>
					<td class="show_detail">E-mail</td>
					<td class="show_detail"><?php echo $row_cust["email"] ?></td>
				</tr>
				<tr>
					<td class="show_detail">Date of Birth</td>
					<td class="show_detail"><?php echo $row_cust["dob"] ?></td>
				</tr>
				<tr>
					<td class="show_detail">Gender</td>
					<td class="show_detail"><?php echo $row_cust["gender"] ?></td>
				</tr> 
				<tr>
					<td class="show_detail">Address</td>
					<td class="show_detail"><?php echo $row_cust["address"] ?></td>
				</tr>
				<tr>
					<td class="show_detail">Account No</td>
					<td class="show_detail"><?php echo $row_acc["acc_no"] ?></td>
				</tr>
				<tr>
					<td class="show_detail">Customer Id</td>
					<td class="show_detail"><?php echo $row_cust["cust_id"] ?></td>
				</tr>
			</table>
			</div></center>	 
		</div>
